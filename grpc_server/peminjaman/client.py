import peminjaman_pb2_grpc as peminjaman_pb2_grpc
import peminjaman_pb2 as peminjaman_pb2
import grpc
...
class PeminjamanClient:
    ...
    def get_peminjaman(self, id):
        response = self.stub.GetPeminjaman(peminjaman_pb2.PeminjamanRequest(
            id=id
        ))
    ...
    def create_peminjaman(self, id_buku,id_anggota,tanggal_peminjaman,tanggal_pengembalian,status):
        response = self.stub.CreatePeminjaman(peminjaman_pb2.PeminjamanCreateRequest(
            id_buku=id_buku,
    ...
    def update_peminjaman(self, id, id_buku,id_anggota,tanggal_peminjaman,tanggal_pengembalian,status):
        response = self.stub.UpdatePeminjaman(peminjaman_pb2.PeminjamanUpdateRequest(
            id=id,
            id_buku=id_buku,
            id_anggota=id_anggota,
            tanggal_peminjaman=tanggal_peminjaman,
    ...
    def delete_peminjaman(self, id):
        response = self.stub.DeletePeminjaman(peminjaman_pb2.PeminjamanDeleteRequest(
            id=id
        ))
